...
export default async function Home() {
  ...
  return (
    <main>
      ...
      >
        <div className="flex flex-col lg:flex-row items-center junstify-center gap-12">
          ...
          <div className="max-w-7xl w-full px-4 md:px-8 mx-auto">
            ...
            <p className="max-w-[600px] lg:text-lg text-gray-500 font-light dark:text-gray-40">
      ...
      >
        ...
        <div className="relative pl-16 after:absolute after:inset-y-0 after:left-0 after:w-px after:bg-gray-500/20 dark:after:bg-gray-400/20 grid gap-10">
